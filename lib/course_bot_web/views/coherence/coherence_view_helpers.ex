defmodule CourseBotWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers CourseBotWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CourseBotWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CourseBotWeb.Gettext, "errors", msg, opts)
    end
  end
